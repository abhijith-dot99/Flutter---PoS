...
//       // return 'Db_bizdot.db';
//       return 'DB_Bizdot_New.db';
//     } else {
//       // Android-specific path
//       final databasesPath = await getDatabasesPath();
//       print("platfrom android");
//       // return join(databasesPath, 'Db_bizdot.db');
//       return join(databasesPath, 'DB_Bizdot_New.db');
//     }
//   }
...
//     // Check if the tax entry already exists in the database
//     final List<Map<String, dynamic>> existingTax = await db.query(
//       'DB_sales_tax',
//       where: 'company_name = ?',
//       whereArgs: [tax.companyName],
//     );

//     if (existingTax.isEmpty) {
//       // If no existing tax is found, insert the new entry
//       await db.insert(
//         'DB_sales_tax',
//         tax.toMap(),
//         conflictAlgorithm: ConflictAlgorithm.replace,
//       );
//       print("Tax inserted: ${tax.taxname}");
//     } else {
//       print("Tax already exists: ${tax.taxname}");
//     }
//   }
...
//     final db = await database;
//     print("companynamegetonline$companyName");
